...
# CHROMA_DIR should point to the rag-service/chroma_store to stay consistent
CHROMA_DIR = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "rag-service", "chroma_store")
