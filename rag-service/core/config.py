...
class Settings(BaseSettings):
    ...
    # Auth Service URL (add this)
    AUTH_SERVICE_URL: str = "http://localhost:8000"  # Auth service endpoint
...
if os.environ.get('RENDER'):
    ...
    # Override auth service URL in production if needed
    if os.environ.get('AUTH_SERVICE_URL'):
        settings.AUTH_SERVICE_URL = os.environ.get('AUTH_SERVICE_URL')
